...
const app = express();
const path = ([
    'index', 'login', 'list-wisata', 'tambah-wisata', 'list-pengguna', 'tambah-pengguna', 'list-pengelola', 'tambah-pengelola', 'laporan-kunjungan', 'laporan-pendapatan', 'grafik-kunjungan', 'grafik-pendapatan'
]);
